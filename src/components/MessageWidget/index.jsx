    ...
    <>
      {/* {toggleMessage.toggle === false && (
                ...
                >
                    ...
                    <span className={`text-base font-medium text-[var(--text-color)]`}>{ServeLangItem().Messages}</span>
                </button>
            )} */}
      <div
      ...
      >
        ...
        >
          <div
            className={`w-full h-[38px] primary-bg text-[var(--text-color)]`}
          >
            <div
            ...
            >
              <div className={`flex space-x-2.5 items-center`}>
                ...
                <span
                  className={`text-base font-medium text-[var(--text-color)]`}
                >
                      ...
                      >
                        <div className={`w-[44px] h-[44px]  relative `}>
                          ...
                          {item.unread_message > 0 && (
                            <div className="w-[15px] h-[15px] inline-block flex justify-center items-center rounded-full primary-bg text-[var(--text-color)] absolute right-0 top-0 text-xs">
                              <span>
                        ...
                        <div className={`flex-1`}>
                          <div className={`flex flex-col space-y-1`}>
                            <p
                              className={`font-medium text-base text-[var(--text-color)] line-clamp-1`}
                            >
                              {item.shop_name}
                            </p>
                            ...
                            {item.send_by === "seller" ? (
                              <div key={i} className="mb-2 mr-10">
                                ...
                                <div className={`w-full`}>
                                  <div
                                    className="bg-[#E8EEF2] py-[8px] px-[17px] flex justify-center rounded-[40px] text-[var(--text-color)] text-sm"
                                    style={{
                                ...
                                <div>
                                  ...
                                  {item.message && (
                                    <div className={`flex justify-end `}>
                                      <div>
                                        <div
                                          className="primary-bg py-[8px] px-[17px] flex justify-center rounded-[40px] text-[var(--text-color)] text-sm"
                                          style={{
                                            maxWidth: "fit-content",
                                            minWidth: "82px",
                                          }}
                ...
                >
                  ...
                  <div className="flex items-center space-x-5">
                    ...
                    <button
                      onClick={() => send()}
                      type="button"
                      className={`w-[50px] h-full primary-bg flex justify-center items-center text-[var(--text-color)]`}
                    >
                      <span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
