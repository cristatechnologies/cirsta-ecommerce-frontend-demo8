  ...
  const doLogin = async () => {
    ...
    await apiRequest
      ...
      .then((res) => {
        ...
        setCookie("userData", JSON.stringify(res.data), { maxAge: 7 });
      })
      .catch((err) => {
        setLoading(false);
        if (err.response) {
        ...
        <div className="signin-area mb-3.5">
          <div className="flex justify-center">
            <button
              onClick={doLogin}
              type="button"
              className="bg-[var(--primary-color)] mb-6 text-sm text-white w-full h-[50px] font-semibold flex justify-center bg-purple items-center"
            >
